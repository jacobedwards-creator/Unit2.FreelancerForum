...
//add function to find new average using updated array
function updateAveragePrice() {
    const avgPrice = freelancers.reduce((sum, freelancer) => sum + freelancer.Starting_price, 0)
     / freelancers.length;
    document.querySelector("#newaverage").textContent = avgPrice.toFixed(2);
    }
//create a function to render array data into table
function renderFreelancers(tbody) {
    ...
    //call function to update average price
    updateAveragePrice();
    }
...
function init() {
    ...
    const freelance_table = document.querySelector("#freelancerlist");
